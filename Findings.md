...
## Comparisons of variations within BERTopic for contemporaneous returns(reduced dimension before clustering is 10 here)
   ...
   * Training error:
   ...
   |PCA+GMM|$3.813\times10^{-4}$|$5.782\times10^{-4}$|$3.477\times10^{-4}$||||||
   ...
   * Testing error:
   ...
   |PCA+GMM|$3.926\times10^{-4}$|$6.012\times10^{-4}$|$3.604\times10^{-4}$|
   ...
   * Training error:
   ...
   |PCA+GMM|$3.799\times10^{-4}$|$5.711\times10^{-4}$|$3.470\times10^{-4}$||||||||
   ...
   * Testing error:
   ...
   |PCA+GMM|$3.910\times10^{-4}$|$6.005\times10^{-4}$|$3.602\times10^{-4}$|

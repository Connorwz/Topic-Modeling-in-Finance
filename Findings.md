...
## Comparisons of variations within BERTopic for contemporaneous returns(reduced dimension before clustering is 10 here)
   ...
   * In-sample $R^2$:
   ...
   |UMAP+GMM|
   |PCA+GMM|0.2910%|0.3338%|0.3375%|0.4142%|0.3785%|0.5506%|3.1096%|0.2263%|0.3528%|0.4442%|
   ...
   * Out-sample $R^2$:
   ...
   |UMAP+GMM|
   |PCA+GMM|0.0480%|0.1289%|-0.0613%|-0.2759%|0.0354%|0.0621%|3.1953%|0.0270%|0.1123%|0.2483%
   ...
   * Whole $R^2$:
   ...
   |UMAP+GMM|
   |PCA+GMM|0.2792%|0.3226%|0.2902%|0.3288%|0.3678%|0.4798%|3.1455%|0.2109%|0.3230%|0.4280%|

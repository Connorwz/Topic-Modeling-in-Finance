...
def pg(num_cluster):
    ...
    hdbscan_model = ClusterModel(GMM(num_components=num_cluster, covariance_type='full'))
...
pos_saved_model_folder = "/shared/share_tm-finance/Stored_model/three_model/pcagmm/pos"
neg_saved_model_folder = "/shared/share_tm-finance/Stored_model/three_model/pcagmm/neg"
neu_saved_model_folder = "/shared/share_tm-finance/Stored_model/three_model/pcagmm/neu"
...
for year in year_list:
    ...
    for i in range(1,6):
        ...
        pos_topic_model = pg(pos_cluster_num)
        neg_topic_model = pg(neg_cluster_num)
        neu_topic_model = pg(neu_cluster_num)
